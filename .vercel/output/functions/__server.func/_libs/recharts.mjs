...
var _excluded$b = ["x1", "y1", "x2", "y2", "key"], _excluded2$6 = ["offset"], _excluded3$5 = ["xAxisId", "yAxisId"], _excluded4$1 = ["xAxisId", "yAxisId"];
...
function HorizontalGridLines(props) {
  ...
  var {
    xAxisId,
    yAxisId
  } = props, otherLineItemProps = _objectWithoutProperties$b(props, _excluded3$5);
...
var _excluded$9 = ["id"], _excluded2$5 = ["type", "layout", "connectNulls", "needClip", "shape"], _excluded3$4 = ["activeDot", "animateNewValues", "animationBegin", "animationDuration", "animationEasing", "connectNulls", "dot", "hide", "isAnimationActive", "label", "legendType", "xAxisId", "yAxisId", "id"];
function _extends$a() {
...
function LineImpl(props) {
  var _resolveDefaultProps = resolveDefaultProps(props, defaultLineProps), {
    ...
    yAxisId,
    id
  } = _resolveDefaultProps, everythingElse = _objectWithoutProperties$9(_resolveDefaultProps, _excluded3$4);
  var {
    needClip
  } = useNeedsClip(xAxisId, yAxisId);
  var plotArea = usePlotArea();
...
var _excluded$7 = ["onMouseEnter", "onMouseLeave", "onClick"], _excluded2$4 = ["value", "background", "tooltipPosition"], _excluded3$3 = ["id"], _excluded4 = ["onMouseEnter", "onClick", "onMouseLeave"];
function _extends$7() {
...
function BarBackground(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    ...
    var {
      ...
      tooltipPosition
    } = entry, rest = _objectWithoutProperties$7(entry, _excluded2$4);
...
function BarRectangleWithActiveState(props) {
  ...
  var content = /* @__PURE__ */ reactExports.createElement(BarRectangle, _extends$7({}, baseProps, {
...
function BarRectangleNeverActive(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(BarRectangle, _extends$7({}, baseProps, {
    name: String(baseProps.name)
  }, entry, {
    isActive: false,
    option: shape,
...
function BarRectangles(_ref3) {
  ...
  var _ref4 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(props)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, {
    id
  } = _ref4, baseProps = _objectWithoutProperties$7(_ref4, _excluded3$3);
  var {
    shape,
    dataKey,
    activeBar
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, data.map((entry, i) => {
    return /* @__PURE__ */ reactExports.createElement(BarStackClipLayer, _extends$7({
      index: entry.originalDataIndex,
...
Bar.displayName = "Bar";
var _excluded$6 = ["option", "isActive"];
function _extends$6() {
...
function ScatterSymbol(_ref2) {
  ...
  if (typeof option === "string") {
    return /* @__PURE__ */ reactExports.createElement(Shape, _extends$6({
      option: /* @__PURE__ */ reactExports.createElement(Symbols, _extends$6({
        type: option
      }, props)),
      isActive,
      shapeType: "symbols"
...
var _excluded$5 = ["id"], _excluded2$3 = ["onMouseEnter", "onClick", "onMouseLeave"], _excluded3$2 = ["animationBegin", "animationDuration", "animationEasing", "hide", "isAnimationActive", "legendType", "lineJointType", "lineType", "shape", "xAxisId", "yAxisId", "zAxisId"];
...
function ScatterLine(_ref2) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(line)) {
    ...
    lineItem = /* @__PURE__ */ reactExports.createElement(Curve, _extends$5({}, lineProps, {
      type: lineJointType
    }));
  }
  return /* @__PURE__ */ reactExports.createElement(Layer, {
...
function ScatterSymbols(props) {
  ...
  var {
    id
  } = allOtherScatterProps, allOtherPropsWithoutId = _objectWithoutProperties$5(allOtherScatterProps, _excluded$5);
  var activeIndex = useAppSelector(selectActiveTooltipIndex);
  var {
    onMouseEnter: onMouseEnterFromProps,
    onClick: onItemClickFromProps,
    onMouseLeave: onMouseLeaveFromProps
  } = allOtherScatterProps, restOfAllOtherProps = _objectWithoutProperties$5(allOtherScatterProps, _excluded2$3);
  var onMouseEnterFromContext = useMouseEnterItemDispatch(onMouseEnterFromProps, dataKey, id);
  var onMouseLeaveFromContext = useMouseLeaveItemDispatch(onMouseLeaveFromProps);
  var onClickFromContext = useMouseClickItemDispatch(onItemClickFromProps, dataKey, id);
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement(ScatterLine, {
    ...
    var symbolProps = _objectSpread$4(_objectSpread$4(_objectSpread$4({}, baseProps), entry), {}, {
      index: i,
    ...
    }, /* @__PURE__ */ reactExports.createElement(Layer, _extends$5({
      className: "recharts-scatter-symbol"
    }, adaptEventsOfChild(restOfAllOtherProps, entry, i), {
      onMouseEnter: onMouseEnterFromContext(entry, i),
      onMouseLeave: onMouseLeaveFromContext(entry, i),
      onClick: onClickFromContext(entry, i)
    }), /* @__PURE__ */ reactExports.createElement(ScatterSymbol, _extends$5({
      option,
      isActive
    }, symbolProps))));
  }));
...
function ScatterImpl(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement(SetScatterTooltipEntrySettings, {
    ...
    tooltipType: props.tooltipType,
    id: props.id
  }), /* @__PURE__ */ reactExports.createElement(ScatterWithId, _extends$5({}, everythingElse, {
    xAxisId,
    yAxisId,
    zAxisId,
    lineType,
...
function ScatterFn(outsideProps) {
  ...
  return /* @__PURE__ */ reactExports.createElement(RegisterGraphicalItemId, {
    ...
    tooltipType: props.tooltipType,
    isPanorama
  }), /* @__PURE__ */ reactExports.createElement(ScatterImpl, _extends$5({}, props, {
    id
  }))));
}
